...
function IpLocation() {
    ...
    return (
        <Card className="col-6">
            <div style={{paddingTop:10,paddingLeft:10,paddingRight:10}} className="d-inline-flex flex-shrink-1">IP address: {succesfulFetchIP ? fetchDataIP.ip : `Loading: ${fetchDataIP}`}</div>
